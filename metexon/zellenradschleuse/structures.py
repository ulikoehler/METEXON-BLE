"""Zellenradschleuse-specific binary structure (de)serialization.

Copied/adapted from top-level metexon.structures, kept separate to allow
future device families with distinct layouts.
"""
...
# Reuse same layouts as existing firmware; duplicating ensures namespace clarity.
